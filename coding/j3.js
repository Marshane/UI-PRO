(function() {
    ...
    var oc = function() {
        ...
        , ge = function(a, b, c) {
            1 <= 100 * Math.random() || Aa("?") || (a = ["t=error", "_e=" + a, "_v=j39", "sr=1"],
            b && a.push("_f=" + b),
    ...
    function Pa(a) {
        ...
        Qa.map(function(b, e) {
            if (e.F) {
                var g = a.get(b);
                void 0 != g && g != e.defaultValue && ("boolean" == typeof g && (g *= 1),
                    c.push(e.F + "=" + K("" + g)))
            }
        });
        c.push("z=" + Bd());
    ...
    function Hc(a) {
        var b = O.gaData;
        b && (b.expId && a.set(Nc, b.expId),
        b.expVar && a.set(Oc, b.expVar))
    }
    function cd() {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/
        ...
        , Jc = function(a, b) {
            ...
            b && (J(9),
                a.data.set(Q, K(b)));
            a.get(Q) || ((c = (c = O.gaGlobal && O.gaGlobal.vid) && -1 != c.search(/^(?:utma\.)?\d+\.\d+$/) ? c : void 0) ? (J(17),
                a.data.set(Q, c)) : (J(8),
                a.data.set(Q, [fe() ^ Mc() & 2147483647, Math.round((new Date).getTime() / 1E3)].join("."))));
            mc(a)
        }
        , Kc = function(a) {
            var b = O.navigator
            ...
            if (a.u)
                ...
                if (a.A)
                    ...
                    if (a.i) {
                        ...
                        b == N || b.get(V);
                        var g = Yd.get(d);
                        ea(g) ? (b.plugins_ = b.plugins_ || new ee,
