...
// angular.module('dialogs.controllers',['ui.modal','pascalprecht.translate'])
	 ...
	 */
	ctrlrs.controller('errorDialogCtrl',['$scope','$modalStack','$translate','$timeout','data',function($scope,$modalStack,$translate,$timeout,data){
		//-- Variables -----//
		...
		$scope.close = function(){
			...
			$modalStack.close(modal.key, 'backdrop click');
			//$modalInstance.close();
			$timeout(function(){
				$scope.$destroy();
			});
	 ...
	 */
	ctrlrs.controller('notifyDialogCtrl',['$scope','$modalStack','$translate','$timeout','data',function($scope,$modalStack,$translate,$timeout,data){
		//-- Variables -----//
	 ...
	 */
	ctrlrs.controller('confirmDialogCtrl',['$scope','$modalInstance','$translate','$timeout','data',
		function($scope,$modalInstance,$translate,$timeout,data){
			//-- Variables -----//
...
//== Dialogs.Main Module =====================================================//
	...
	angular.module('ui.dialogs',['dialogs.services','ngSanitize']) // requires angular-sanitize.min.js (ngSanitize) //code.angularjs.org/1.2.1/angular-sanitize.min.js
			...
			.run(['$templateCache','$interpolate',function($templateCache,$interpolate){
				...
				$templateCache.put('/dialogs/error.html','<div class="modal-header dialog-header-error"><h4 class="modal-title text-danger"> <span ng-bind-html="header"></span></h4></div><div class="modal-body text-danger" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-default ui-btn-success ui-btn-radius" ng-click="close()">知道了</button></div>');
				...
				$templateCache.put('/dialogs/notify.html','<div class="modal-header dialog-header-notify"><h4 class="modal-title text-info">'+startSym+'header'+endSym+'</h4></div><div class="modal-body text-info" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary  ui-btn-success ui-btn-radius" ng-click="close()">知道了</button></div>');
				$templateCache.put('/dialogs/confirm.html','<div class="modal-header dialog-header-confirm"><h4 class="modal-title">'+startSym+'header'+endSym+'</h4></div><div class="modal-body" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn  ui-btn ui-btn-success ui-btn-success ui-btn-radius" ng-click="yes()">确认</button><button type="button" class="btn btn-primary  ui-btn-radius" ng-click="no()">取消</button></div>');
